    ...
    <div class="container-fluid">
        ...
        <div class="abs2 mx-2 mt-4">
            ...
            <div class="row pb-3">
                <div class="col-md-4 px-5 border-right border-primary">
                    &emsp;Chúng tôi tự hào là một trong những đơn vị hàng đầu trong lĩnh vực bán máy tính. Chúng tôi cam
                    kết mang lại
                    cho khách hàng những sản phẩm và dịch vụ chất lượng nhất, đồng thời luôn lắng nghe và đáp ứng mọi
                    nhu cầu
                    của khách hàng. Với đội ngũ nhân viên nhiệt tình, giàu kinh nghiệm và chuyên môn cao, chúng tôi đảm
                    bảo
                    sẽ mang đến cho quý khách một trải nghiệm mua hàng tốt nhất.
                </div>
                <div class="col-md-4 px-5 border-right border-primary">
                    &emsp;Đại diện cho các thương hiệu lớn nhất trong ngành công nghiệp máy tính, chúng tôi cam kết cung
                    cấp những
                    sản phẩm chất lượng, hiệu quả và đa dạng nhất cho khách hàng. Chúng tôi cũng cung cấp dịch vụ hậu
                    mãi tốt
                    nhất để đảm bảo rằng khách hàng của chúng tôi sẽ luôn hài lòng với sản phẩm mà mình đang sử dụng.
                </div>
                <div class="col-md-4 pr-5">
                    &emsp;Chúng tôi hiểu rằng khách hàng là yếu tố quan trọng nhất trong sự phát triển của chúng tôi. Vì
                    vậy, chúng
                    tôi cam kết sẽ luôn đáp ứng những nhu cầu của khách hàng bằng cách cung cấp những sản phẩm chất
                    lượng nhất,
                    dịch vụ tốt nhất và giá cả cạnh tranh nhất. Chúng tôi hy vọng sẽ có thể trở thành đối tác đáng tin
                    cậy
        ...
        <div class="row mx-auto my-5 text-justify abs3">
            <div class="col-md-3 px-3 py-2 mx-5 border border-secondary">
                <h3>TẦM NHÌN</h3>
                &emsp;Tầm nhìn của chúng tôi là trở thành đơn vị hàng đầu trong lĩnh vực bán máy tính, mang đến cho
                khách
            ...
            <div class="col-md-3 px-3 py-2 mx-5 border border-secondary">
                <h3>SỨ MỆNH</h3>
                &emsp;Sứ mệnh của chúng tôi là giúp khách hàng tận hưởng những trải nghiệm tốt nhất khi mua sắm và sử
                dụng
            ...
            <div class="col-md-3 px-3 py-2 mx-5 border border-secondary">
                ...
                &emsp;Giá trị cốt lõi của chúng tôi là sự tận tâm và trung thực trong kinh doanh. Chúng tôi cam kết luôn
                đặt
        ...
        <div class="row mx-2 my-3 abs4 text-justify">
            ...
            <div class="col-md-3 abs4-img">
                ...
                <a href=""><i class="bi bi-youtube"></i></a>
                <a href=""><i class="bi bi-envelope"></i></a>
                <p class="text-justify">Với kinh nghiệm phát triển Front-end, tôi đã giúp nhà phát triển Back-end của
                    chúng tôi tạo ra các trang
            ...
            <div class="col-md-3 abs4-img">
                ...
                <a href=""><i class="bi bi-youtube"></i></a>
                <a href=""><i class="bi bi-envelope"></i></a>
                <p class="text-justify"> Với những kiến thức chuyên sâu và chuyên môn về các ngôn ngữ lập trình như
                    Java, Python,
            ...
            <div class="col-md-3 abs4-img">
                ...
                <a href=""><i class="bi bi-youtube"></i></a>
                <a href=""><i class="bi bi-envelope"></i></a>
                <p class="text-justify">Với khả năng phân tích và truyền đạt các lỗi và điều chỉnh cần thiết cho đội ngũ
                    phát triển,
        ...
        <p class="abs6"> Chúng tôi đã làm việc với nhiều khách hàng và chúng tôi luôn muốn nghe rằng họ vui vẻ và hài
            lòng sau
