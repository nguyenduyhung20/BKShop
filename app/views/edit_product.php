						...
						<div class="card">
							...
							<div class="card-body">
								...
								<table id="add-prd" border="0" cellpadding="0" cellspacing="0">
							    	<tr>
							        	<td><label>Tên sản phẩm</label><br /><input type="text" name="name_product" value="<?php if(isset($_POST['name_product'])){echo $_POST['name_product'];}else{echo $arr['name_product'];}?>" /></td><?php if(isset($error_name_product)){echo $error_name_product;}?>
							        </tr>
							        <tr>
							        	<td><label>Ảnh mô tả</label><br /><input type="file" name="image_product" /><input type="text"  disabled name="image_product" value="<?php echo $arr['image_product'];?>" /></td>
							        </tr>
							        <tr>
							        ...
							        <tr>
							        	<td><label>Giá sản phẩm</label><br /><input type="text" name="price_product" value="<?php if(isset($_POST['price_product'])){echo $_POST['price_product'];}else{echo $arr['price_product'];}?>" /></td><?php if(isset($error_price_product)){echo $error_price_product;}?>
							        </tr>
							        <tr>
							        	<td><label>Sản phẩm đặc biệt</label><br />Có <input type="radio" name="special" value=1 <?php if($arr['special']==1){echo 'checked';} ?>/> Không <input type="radio" name="special" value=0 <?php if($arr['special']==0){echo 'checked';} ?>/></td>
							        </tr>
							        <tr>
							        	<td><label>Thông tin chi tiết sản phẩm</label><br /><textarea cols="60" rows="12" name="description_product">
							                <?php if(isset($_POST['description_product'])){echo $_POST['description_product'];}else{echo $arr['description_product'];}
							                ?></textarea></td>
							            <?php if(isset($error_description_product)){echo $error_description_product;}?>
							        </tr>
							        <tr>
